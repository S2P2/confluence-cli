...
import { htmlToMarkdown, htmlToPlainText, markdownToHtml, markdownToStorage } from '../utils/convert.js'
...
export function registerConvertCommand(program: Command): void {
  program
    ...
    .action(
      async (options: { inputFile?: string; outputFile?: string; inputFormat?: string; outputFormat?: string }) => {
